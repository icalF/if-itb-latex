...
\section{Rumusan Masalah}
  ...
  \begin{enumerate}
      \item Apa saja rancangan-rancangan yang akan digunakan untuk pencocokan \emph{signature} dengan GPU?
...
\section{Tujuan}
  ...
  \begin{enumerate}
      \item Mencari rancangan-rancangan yang akan digunakan untuk pencocokan \emph{signature} dengan GPU
